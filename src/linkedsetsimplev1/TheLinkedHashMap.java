    ...
    implements Map<K,V>
{
     ...
     * LinkedHashMap entry.
     */
    private static class Entry<K,V> extends TheHashMap.Entry<K,V> {
        // These fields comprise the doubly linked list used for iteration.
        Entry<K,V> before, after;

        Entry(int hash, K key, V value, TheHashMap.Entry<K,V> next) {
        ...
        void recordAccess(TheHashMap<K,V> m) {
            TheLinkedHashMap<K,V> lm = (TheLinkedHashMap<K,V>)m;
            if (lm.accessOrder) {
                lm.modCount++;
                remove();
                addBefore(lm.header);
    ...
    private abstract class LinkedHashIterator<T> implements Iterator<T> {
        ...
        public void remove() {
            ...
            TheLinkedHashMap.this.remove(lastReturned.key);
            lastReturned = null;
    ...
    void createEntry(int hash, K key, V value, int bucketIndex) {
        TheHashMap.Entry<K,V> old = table[bucketIndex];
